...
//记录log
logControl.log = function(api,params,errorMessage,callback)
{
    var c = new command('INSERT INTO errorlog(api,params,errorMessage,createAt) VALUES(?,?,?,?)',[api,params,errorMessage,parseInt(new Date().getTime()/1000)]);
